...
if __name__ == '__main__':
    ...
    rag_qa_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(rag_qa_dir, 'data', 'test_data')
    # main(query_mode=False, directory_path=data_path)
    main(query_mode=True, directory_path=data_path)
